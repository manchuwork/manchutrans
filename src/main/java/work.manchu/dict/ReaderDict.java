...
//        return pre + transNodeProcesser.trans(after);
        ...
        CsvWriter csvWriter = new CsvWriter(Path.of(outputDir ,file).toFile().getPath(), ',', Charset.forName("utf-8"));
